...
- Gemini Kit
  ...
  - 底板２枚 (2mm)
  - ボトムプレート２枚 (3mm)
  - ローワーミドルフレーム 右手・左手各１枚 (3mm)
  - ミドルフレーム 上側・下側各２枚 (2mm)
  - ローワートッププレート２枚 (2mm)
  - トッププレート２枚 (3mm)
  - トップフレーム薄・厚各２枚 (2mm/3mm)
- Gemini Kit -- 予備パーツ
  - ローワーミドルフレームの薄め版 (2mm)
  - トップフレーム厚 (3mm)
- MX 互換キースイッチ x40
...
- 底板を省略すると、一部の電子部品がむき出しになってしまう代わりに打面の高さを 2mm 下げることができます。打ちやすさだけで言えば下がっていた方が打ちやすいと思います

- トップフレームは 2mm 厚のものが１セットと、3mm 厚のものが２セット付属します。 2mm と 3mm を合わせて計 5mm とすることを想定していますが、適宜組み合わせることで好みの厚みにすることができます

- コンスルーの足を切ると、ローワーミドルフレームを 2mm の薄い方に変えて打面の高さを 1mm 下げることができます。使用する TRRS ケーブルによっては穴の高さが足らなくなる場合があるので注意してください

使用するプレートの厚みをカスタマイズする場合、必要なネジの長さが変わってくる場合があるので注意してください
...
1. バックライト（穴に落として背面実装するもの） … Pro Micro に近い側の、一番上のキー（表から見ると左上）から横方向に進み、端まで来たら次の行の Pro Micro に近い側に戻る

2. アンダーグロー（通常の表面実装） … Pro Micro に近い側の、上側から同様の順
...
Pro Micro を外し、スイッチを実装します。基板にローワートッププレート、トッププレートをこの順に重ね、スイッチを奥まではめ込み、裏から半田付けします。 Pro Micro の裏にくるスイッチの足はカットする必要がある場合があります（Pro Micro の個体によってはそのままでも干渉せずに取り付けられることがあります）。
